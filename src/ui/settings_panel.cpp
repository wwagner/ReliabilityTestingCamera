...
void SettingsPanel::render_digital_features() {
    ...
    // Note: Legacy manual feature code removed (369 lines)
    // All digital features (ERC, Anti-flicker, Trail Filter, ROI, Digital Crop)
    // are now managed by FeatureManager class for better modularity and maintainability
}
