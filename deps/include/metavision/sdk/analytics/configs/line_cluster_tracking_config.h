...
struct LineClusterTrackingConfig {
    ...
    LineClusterTrackingConfig(unsigned int bitsets_buffer_size, unsigned int cluster_ths = 3,
                              unsigned int num_clusters_ths = 4, unsigned int min_inter_clusters_distance = 1,
                              float learning_rate = 1.f, float max_dx_allowed = 5.f,
                              unsigned int max_nbr_empty_rows = 0) :
