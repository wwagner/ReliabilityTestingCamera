...
class [[deprecated("This class is deprecated since version 4.5.2 and will be replaced by the "
                   "SpatterTrackerAlgorithmSync version in a future release")]] SpatterTrackerAlgorithm {
public:
    ...
    [[deprecated("This function is deprecated since version 4.3.0. Please use add_nozone() instead.")]] void set_nozone(
...
private:
    ...
    std::unique_ptr<EventBufferReslicerAlgorithm> slicer_;
    TrackerCb output_cb_;
    std::vector<EventSpatterCluster> output_clusters_;
};
