...
private:
    ...
    void notify_new_best_estimate_impl([[maybe_unused]] unsigned int iteration) {}
    void notify_starting_minimization_impl() {}
    void notify_ending_minimization_impl() {}
    void notify_last_jacobian_and_hessian_impl([[maybe_unused]] const CostJacobian &jacobian,
                                               [[maybe_unused]] const Hessian &hessian) {}
};
} // namespace Metavision
