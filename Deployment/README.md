...
3. Adjust bias sliders while watching live view
4. Click "Apply Bias Changes" to test
5. Run noise analysis to measure impact
6. Iterate until SNR is maximized
7. Update `event_config.ini` with final values
...
│   └── ui/                          # User interface
├── src/                             # Source files
│   ├── main.cpp                     # Application entry (484 lines)
│   ├── core/                        # Core modules
...
- **v2.0** - Streamlined architecture (Current)
  - Single camera viewer with integrated controls
